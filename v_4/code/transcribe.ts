...
export class mock_up extends view {
    ...
    //
    async show_images(): Promise<void> {
        //
        ...
        const result: Array<{ name: string }> = await this.exec_php(
            //
        ...
        for (let i = 0; i < result.length; i++) {
            ...
            const img: HTMLImageElement = this.create_element(
                //
            ...
            const name: string = result[i].name;
            //
    ...
    async show_receipt(): Promise<void> {
        //
        //Formulating an sql statement for retrieving the file names from the database.
        //Following the "zone standards"
        const statement: string = `
    ...
    async show_purchase(): Promise<void> {
        //
        //Formulating an sql statement for retrieving the file names from the database.
        //Following the "zone standards"
        const statement: string = `

...
export class peer extends mypanel {
    ...
    show_selection(clicked) {
        ...
        if (pk === undefined)
            throw new mutall_error('Selection not found!');
        //
...
export class supplier extends mypanel {
    ...
    show_selection(clicked) {
        //
        const cell = this.cells_relative?.[0]?.[0];
        //
        if (cell)
            cell.select();
    }
...
export class image_group extends panel.group {
    ...
    constructor(parent) {
        ...
        const peers = [File, Image_panel, Receipt];
        //

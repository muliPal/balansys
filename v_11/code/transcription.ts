...
export abstract class peer extends panel{
    ...
    async modify_driver():Promise<void>{
        ...
        if (!(this.driver instanceof drivers.sql)) throw new mutall_error('Only sql drivers are supported');
        this.driver.sql = sql;
    }
}
...
class file extends peer{
    ...
    public plan:plan = [
        ...
        [new homozone(null, {class_name:'header'}), this.get_header({class_name:'header'})],
        //
    ...
    constructor(parent:group){
        ...
        //    
        super(file.sql, 'image.image',  options, parent, 'path');
    }   
}
...
class image extends peer{
    ...
    constructor(parent:group){
        ...
        //    
        super(image.sql, 'image.image',  options, parent,'image');
    }   
}
...
class receipt extends peer{
    ...
    constructor(parent:group){
        ...
        //    
        super(receipt.sql, 'image.image',  options, parent, 'receipt.ref');
...
class purchase extends panel{
    ...
    constructor(parent:transcription){
        ...
        //    
        super(purchase.sql, 'purchase.purchase',  options, parent, 'ref');
    }
...
export class supplier extends panel{
    ...
    constructor(parent:view){
        ...
        const selection_cname: string = 'supplier.name';
        
        //
        super(supplier.sql, row_index_cname, options, parent, selection_cname)        
    }
    
    public show_selection(cell?: cell): void {

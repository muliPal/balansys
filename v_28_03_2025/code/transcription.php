...
<html>
    ...
    <body>
        ...
        <div id="nav">
            <button onclick="page.pan(-10, 0)">&#11160; Left</button>
            <button onclick="page.pan(10, 0)">&#11162; Right</button>
            <button onclick="page.pan(0, -10)">&#11161; Up</button>
            <button onclick="page.pan(0, 10)">&#11163; Down</button>

...
import { view, label, mutall_error, basic_value } from "../../../schema/v/code/schema.js";
//
...
abstract class mypanel extends panel.panel{
    ...
    //
    constructor(public sql:string, row_index:string, anchor: HTMLElement | string, options: table_options, parent: view){
        //
...
export class transcription extends panel.group{
    //
    public consumer:mypanel;
    public image_panel:peer;
    public file:peer;
    public receipt:peer;
    public purchase:mypanel;
    public supplier:mypanel;
    //
    //This helps us to manage the peer panels 
    public image_group:panel.group;
    //

import { homozone, } from "../../../outlook/v/zone/zone.js";
import { mutall_error } from "../../../schema/v/code/schema.js";
//
//This file is being developed as part of the mutall library
import { panel, group, reviewer, creator } from "./panel.js";
...
export class peer extends panel {
    //
    constructor(sql, row_index_cname, options, 
    //
    //Peers are managed as a unit,
    parent, selection_cname) {
...
export class consumer extends panel {
    ...
    plan = [
        ...
        [new reviewer(this, 0, false, 'open', { onchange: (cell) => this.onclick_from_reviewer(cell) }), this, new reviewer(this, 0, true, 'write')],
        //
...
class receipt extends peer {
    ...
    plan = [
        ...
        [
            this.get_leftie(),
            new reviewer(this, 0, false, 'open', { onchange: (cell) => this.onclick_from_reviewer(cell) }),
            this,
            //
...
class purchase extends panel {
    ...
    async modify_driver() {
        ...
        const { row_index } = this.driver_source;
        //
